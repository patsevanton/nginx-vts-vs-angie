...
> Поверх всех возможностей [nginx 1.31.3](https://nginx.org/en/CHANGES), **Angie** добавляет ряд собственных преимуществ. Ниже — детальный разбор каждой фичи: что это, чем полезно и где применимо.
